...
namespace Drakkar
{
	public static class DrakkarEditor
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void DrakkarPropertyInspector(SerializedObject ob,string pr,float width=-1,bool recolor=false,float lableTndent=0,bool applyProperties=true)
		{
			SerializedProperty p=ob.FindProperty(pr);
			if (width<0)
